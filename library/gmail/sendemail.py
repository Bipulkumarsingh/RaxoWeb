        ...
        <html>
          <body>
            <p>Hi {username},<br><br>
               ...
               <a href="https://www.company.com"><h2>company</h2></a>
            </p>
            <p>
            Do not share this OTP with anyone. company takes your account security very 
            seriously. company Customer Service will never ask you to disclose or 
            verify your company password, OTP and any information. 
            If you receive a suspicious email with a link to update your account 
            information, do not click on the link—instead,report the email to company 
            for investigation. 
            <br><br>
