...
def mail_otp(receiver, pin_code, username):
    ...
    message = send_inst.create_otp('yourmail@gmail.com', receiver, 'Raxoweb OTP Assistant',
                                   pin_code, username)
...
def mail_info(receiver, user):
    send_inst = sendemail.SendEmail(service)
    message = send_inst.create_message('yourmail@gmail.com', receiver,
...
def mail_me(name, sender, mobile, message):
    send_inst = sendemail.SendEmail(service)
    message = send_inst.create_message_for_me('yourmail@gmail.com', 'yourmail@gmail.com',
